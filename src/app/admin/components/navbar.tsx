...
const Navbar = () => {
    ...
    useEffect(() => {
        ...
        if (pathname) {
            const parts = pathname.split('/'); // Membagi path menjadi array berdasarkan '/'
            const lastPart = parts[parts.length - 1]; // Mengambil bagian terakhir dari array

            setBreadcrumb(lastPart); // Set breadcrumb sebagai bagian terakhir dari array
        } else {
            // Jika pathname tidak ada, set breadcrumb sebagai 'dashboard'
